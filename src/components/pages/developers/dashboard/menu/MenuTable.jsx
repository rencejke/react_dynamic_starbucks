...
const MenuTable = ({setItemEdit, isLoading, isFetching, menu}) => {
        ...
        <table className='text-black font-regular'>
                        <thead className='sticky top-0 relative z-10'>
                            <tr>
                                ...
                                <th className='w-[150px]'>Category Id</th>
                ...
                {store.isActive && <ModalConfirmed position="center"  queryKey="menu" endpoint={`/v1/menu/active/${id}`} isArchiving={isArchiving}/>}

                {store.isDelete && <ModalDelete position="center"  queryKey="menu" endpoint={`/v1/menu/${id}`} />} 
    </>
  )
}
