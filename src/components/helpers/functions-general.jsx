export const devBaseImgUrl="http://localhost/react-starbucks/public/img/"

export const baseImgUrl ="../../img"

export const urlPathStarbucks = "http://localhost/react-starbucks";
export const devApiUrl = `${urlPathStarbucks}/rest`;
